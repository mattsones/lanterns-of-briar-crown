...
const lioPortrait = new URL("../../assets/portraits/characters/lio-brindle-portrait-v01.png", import.meta.url).href;
const maraPortrait = new URL("../../assets/portraits/characters/mara-brindle-portrait-v01.png", import.meta.url).href;
const mayorAnwenPortrait = new URL("../../assets/portraits/characters/mayor-anwen-portrait-v01.png", import.meta.url)
  .href;
const miraPortrait = new URL("../../assets/portraits/characters/mira-portrait-v01.png", import.meta.url).href;
const miriPortrait = new URL("../../assets/portraits/characters/miri-portrait-v02.png", import.meta.url).href;
const mossPortrait = new URL("../../assets/portraits/characters/moss-portrait-v01.png", import.meta.url).href;
const nellaPortrait = new URL("../../assets/portraits/characters/nella-portrait-v03.png", import.meta.url).href;
...
const smithOrinPortrait = new URL("../../assets/portraits/characters/smith-orin-portrait-v02.png", import.meta.url)
  .href;
const tildaPortrait = new URL("../../assets/portraits/characters/tilda-portrait-v01.png", import.meta.url).href;
const tomaPortrait = new URL("../../assets/portraits/characters/toma-fielding-portrait-v02.png", import.meta.url).href;
const worriedRoadTravelerPortrait = new URL(
  "../../assets/portraits/characters/worried-road-traveler-portrait-v01.png",
  import.meta.url,
).href;
