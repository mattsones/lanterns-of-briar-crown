...
const TRACE_PRESENTATION: Record<FoldedMapOutcome, {
  ...
  "false-shortcut": {
    ...
    summary: "LATER OFFICE SHORTCUT · Straight and convincing, but the terrain runs backward.",
...
function FrontMapArtwork() {
  return (
    <g data-map-face="front">
      ...
      <text x="520" y="32" fill="#6d5730" fontSize="13" fontWeight="700" letterSpacing="2">LATER OFFICE SHORTCUT</text>
      <text x="900" y="225" fill="#6d5730" fontSize="12" fontWeight="700" letterSpacing="1.6">OFFICE</text>
...
function BackMapArtwork() {
  return (
    <g data-map-face="back">
      ...
      {/* The south-three-quarter fold supplies the missing middle road, keeper ring, and bridge. */}
      ...
      <text x="383" y="315" fill="#6a6040" fontSize="14" letterSpacing="2">REVERSE FACE · OLDER KEEPER FIELD LEAF</text>
      ...
      <svg viewBox={`0 0 ${SHEET_WIDTH} ${SHEET_HEIGHT}`} className="absolute inset-0 h-full w-full overflow-visible" aria-label={`${configuration.side} face of one rectangular paper map`}>
        ...
        {traceOutcome === "true-route" || traceOutcome === "deeper-solve" ? (
          <g data-testid="folded-map-true-evidence" pointerEvents="none">
            ...
            <text x="420" y="214" fill="#134e4a" fontSize="15" fontWeight="900" letterSpacing="2">KEEPER ROUTE CONFIRMED</text>
            <g transform="translate(430 8)">
              ...
              <text x="18" y="27" fill="#571b16" fontSize="12.5" fontWeight="900" letterSpacing="1.2">OFFICE SHORTCUT VOID · TERRAIN REVERSED</text>
            </g>
          </g>
        ) : null}
        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1fr)_21rem]">
          ...
          <aside className="space-y-3">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-4 text-sm leading-6 text-white/70">
              ...
              <div className="mt-1">“The map lies flat. Two turns find the road. At the keeper bridge, roots point beyond it.”</div>
              ...
              <ul className="mt-1 list-inside list-disc space-y-1 text-xs text-white/55">
                <li>the Survey lantern benchmark and an older keeper ring</li>
                <li>two contour strokes meeting without reversal</li>
                <li>one road continuing into the Underway</li>
                <li>the later office shortcut is strikingly straight</li>
              </ul>
