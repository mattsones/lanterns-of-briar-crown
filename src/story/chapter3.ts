...
export const CHAPTER_3_FULL_SCENE_COPY = {
  ...
  mossgarden: {
    nameReaction: "Noma touches two fingers to a blank name tablet beside the water. \"Names are not proof,\" they say. \"They are how proof knows whom it belongs to.\"",
