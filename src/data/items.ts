export const ITEM_DB = {
  ...
  rootbread_charm: { id: "rootbread_charm", name: "Rootbread Charm", rarity: "Story", type: "story", description: "A small token of Westroot hospitality, warm with the promise that roads should shelter as well as lead.", icon: "🍞" },
