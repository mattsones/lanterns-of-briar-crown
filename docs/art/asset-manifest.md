...
| Lower Gate descent / Survey Station gameplay map | `underway-survey-station-map-v01.webp` | A continuous fitted-stone descent from the Lower Gate reaches an abandoned waykeeper table and three non-explorable route shutters. The shutter arches are environmental evidence for the Folded Map rather than branch nodes. Warm fixed light is confined to the old station table. Prompt record: `docs/art/prompts/chapter-4-survey-station-and-rootwater.md`. |
| Rootwater Bridge gameplay map | `rootwater-bridge-map-v01.webp` | Linear old stone crossing above a faintly blue-green underground river, with enormous roots, a non-glowing carved road-crew ring, and fresh westbound tracks. The originally generated parapet lantern was removed at owner request; there is no fixed bridge light. Prompt record: `docs/art/prompts/chapter-4-survey-station-and-rootwater.md`. |
| Underway approach gameplay map | `underway-approach-map-v03.webp` | Owner-approved Chapter 4 pre-choice approach, now reached after Rootwater Bridge. One continuous, moderately serpentine fitted-stone road leads from the old route shutter to an official-looking construction closure; neither later route is visible until the physical detour decision replaces this map. V03 restores Candidate A2's large woven-root essence, removes the unexplained route dial, and balances long-road scale with readable paving and endpoints. Uses runtime-only party-lantern lighting; V01–V02 are preserved in reference alternates. |
...
| Tunnel Rat | `tunnel-rat-v01.webp` | Chapter 4 natural-wildlife portrait; a quick, uncorrupted Underway animal in fitted stone and old roots. |
| Root Gnawer | `root-gnawer-v01.webp` | Chapter 4 natural-wildlife anchor; an older, broad-bodied rat defending a den tangled through ancient roots. |
