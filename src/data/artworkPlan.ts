...
export const PORTRAIT_ARTWORK_PLAN: Record<string, ArtworkPlanEntry> = {
  ...
  ada: entry("ada", "Ada Willowmarket", "portrait", 1, "dialogue emoji", "available"),
  orin: entry("orin", "Smith Orin", "portrait", 1, "dialogue emoji", "available"),
...
export const ENEMY_ARTWORK_PLAN: Record<string, ArtworkPlanEntry> = {
  bramble_boar: entry("bramble_boar", "Bramble Boar", "enemy", 1, "enemy emoji", "available"),
  thorncoat_ruffian: entry("thorncoat_ruffian", "Thorncoat Ruffian", "enemy", 1, "enemy emoji", "available"),
  thorny_hound: entry("thorny_hound", "Thorny Hound", "enemy", 1, "enemy emoji", "available"),
  rustroot_skulk: entry("rustroot_skulk", "Rustroot Skulk", "enemy", 1, "enemy emoji", "available"),
  briar_knot_warden: entry("briar_knot_warden", "Briar Knot Warden", "enemy", 1, "enemy emoji", "available"),
