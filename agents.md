...
Chapters 1-3 have automated playable paths, and Chapter 3 received human-playthrough signoff on 2026-08-02. Chapter 4 now has an executable vertical-slice contract, a tested hinged-paper Folded Map prototype, stable interaction test hooks, and a settled gatewright weapon economy. The first card-matching map spike was rejected; full Chapter 4 story implementation should wait only for owner acceptance of the replacement interaction direction. The uninterrupted Chapters 1-3 playthrough remains deferred to the Chapter 4 release-candidate cycle.
