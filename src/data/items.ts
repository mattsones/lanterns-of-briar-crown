export const ITEM_DB = {
  eddens_three_door_drawing: { id: "eddens_three_door_drawing", name: "Edden's Three-Door Drawing", rarity: "Story", type: "story", description: "A charcoal drawing of three doors beneath roots. The honest one has no handle.", icon: "📜" },
  ...
  no_handle_token: { id: "no_handle_token", name: "No-Handle Token", rarity: "Story", type: "story", description: "A small bronze door-token from the first Westroot threshold. It has no handle because the road opened from the honest side.", icon: "🚪" },
