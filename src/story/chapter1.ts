...
The forged orders were not the whole plan. They were cover. The stolen Willow seal was not a side theft. It was access. And Lio Brindle may not be dead on the road. He may have been moved through the old ways beneath it.`,
    ...
    completionTableau:
      "The Warden comes apart in the chamber behind you: root, rusted chain, broken boards, and false seal-cloth settling into stillness. Beyond it, the sealed iron door remains. The Briar Crown has been cut over older lantern marks, but it has not erased them. Edden's blue cloth hangs from the lantern hook, proof that he reached this place and carried its warning home.\n\nThe battle is over. The road beneath Bramblecross is only beginning to speak.\n\nTake the chain. Take the cloth. Return with the truth.",
    discoveryCompleteToast:
      "Chapter 1 complete. Report back to Hollis and Enna.",
  },
  reportBack: {
    opening:
    ...
    westrootLead:
      "Enna pulls the public road map and old courier marks from a lower shelf, then leaves a deliberate space between them for Edden's testimony.\n\n\"Westroot is not listed like a town,\" she says. \"The name appears as a root mark, a lantern mark, and sometimes a storehouse tally. It may be a route, a gate, a hidden waystation, or all of those wearing one name.\"\n\nShe traces a line from Hearthhollow to Lantern Road, then Bramblecross, then west into a faded cluster of marks.\n\n\"If the command says Westroot opened, and Willow-sealed cargo is being used as cover, then something moved west after the road was confused. Maybe cargo. Maybe prisoners. Maybe Lio.\"\n\nHollis sets the cracked lantern beside the map. \"The sealed cellar door still opens from the far side, so we cannot follow it directly. But an old surface cut west of town reaches the same buried road.\"\n\nEnna begins arranging the journey as she speaks. Mara Brindle knows Lio's private courier marks. Edden may be able to explain the thresholds he remembers. Ada's lens can expose copied Willow seals. Your companion, if you brought one below, has already seen what false authority protects.\n\n\"Speak with Mara, then Edden and Ada,\" Enna says. \"Follow Westroot. Look for Willow-sealed cargo that should not be there and true lantern marks hidden beneath false crowns. And if you find Lio Brindle...\"\n\nShe does not finish the sentence. She does not need to.",
    closingNarration:
    ...
    expeditionReady:
      "The cellar report is pinned to the case wall. Edden's cloth rests beside the cracked lantern, and the Briar Crown mark now has a name without being mistaken for authority.\n\nEnna circles the old surface cut west of Bramblecross. Hollis writes three names beneath it: Mara, Edden, Ada. The report and the plan have become the same piece of work.\n\nChapter 2 begins: follow the Westroot Trail and learn whether Lio survived the gate.",
    closingChoices: [
