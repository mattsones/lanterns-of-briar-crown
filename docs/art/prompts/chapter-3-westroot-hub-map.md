...
4. Witness Stones: a clearly readable circular or semicircular set of four worn standing stones near the Mossgarden, connected by a low water channel. Include a small cracked thorny false-mark plaque or nailed slat nearby, but no text or symbols readable enough to be mistaken for UI.
