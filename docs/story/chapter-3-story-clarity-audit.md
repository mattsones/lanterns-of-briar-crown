...
Repeated uninterrupted playthroughs still require the player to infer foundational events rather than purposeful mysteries. In particular, the current chapter does not clearly establish:

- what it means to keep the Rootbread Promise;
- how Lio could leave blue string at a hatch that nobody opened;
- whether Lio was physically transported inside the counterfeit Willow crate;
- which Westroot gate or passage the Briar Crown used;
- why the party's opening of the First Gate alarms Westroot if Lio and the Briar Crown recently passed through;
- whether Westroot has been completely sealed for a generation or has continued limited, controlled traffic;
- what Bramwell and Split Hall actually reopen at the Witness Stones and at the end of the chapter;
- how significant the final decision is for Westroot's relationship with Bramblecross.

These are causal and physical facts, not mysteries the player should have to solve by inference. The mysteries worth preserving are who supplied the inside authorization, whether that person acted willingly, where Lio is now, and what larger operation the Briar Crown is building.

## Current Continuity Problems

### The Rootbread action is mislabeled

The current completion action is effectively **Tell the child whose blue knot Mara found**, followed by **Thank the child and keep the promise**. The player does not feed anyone, replace the food, promise a future action, or confirm that the food reached the traveler. The flag and toast therefore claim an action that the scene has not dramatized.
...
The crate contains a courier pouch and a transfer tag, and Mara says, "They made a person into cargo." The likely intended meaning is bureaucratic dehumanization: Lio was processed as a freight transfer while being moved with the convoy. The current wording can reasonably be read as Lio having been physically sealed inside the crate, which conflicts with the hatch clue unless an additional escape or pause is explained.

### Several different closures share the same language
...
### The First Gate's recent history is undefined

Chapter 2 places Lio's personal mark at the First Westroot Gate and interprets it as evidence that he was alive past that point. Chapter 3 opens with all of Westroot hearing the party open that gate and Bramwell asking who opened it. Quill nevertheless says Westroot heard that a courier passed through. The story never explains whether:

- Lio passed through this exact gate or only marked the route near it;
- the gate opened for Lio's convoy;
- Westroot knowingly admitted an authorized-looking transfer;
- the Briar Crown used a different cargo or service entrance;
- the party's opening is alarming because it is the first opening in years or because it occurred without a scheduled account mark.
...
The following model resolves the problems above while preserving the current themes and most existing locations. It is a proposal for discussion.
...
### Briar Crown objective

The Briar Crown wants Westroot because it is a junction beneath several settlements. Controlling it allows the faction to move forged orders, supplies, agents, and prisoners while preventing neighboring communities from comparing what they know.

The faction steals the Willow seal for credible outside cargo and obtains a copied, coerced, or compromised Westroot gate-account mark for inside authorization. The exact source of that mark remains the chapter's legitimate unresolved mystery.
...
The Willow-marked crate is the convoy's cover and evidence store, not Lio's container. It holds forged orders, seal tools, restraints, route-altering tools, Lio's confiscated courier pouch, and the transfer record that reduced him to freight in the Briar Crown ledger.

After the westward transfer, Bramwell notices irregularities and places the crate under hold. An agent still hiding in or using Westroot moves it from the assigned bay deeper into Cargo Siding, brushes the tracks, and resets the lock. This movement triggers the Hold Bell during the player's visit.

### Why the player's gate opening is alarming

The party's arrival is not necessarily the first physical opening of the First Gate in a generation. It is alarming because the gate opens without a scheduled arrival, a Gatehand key, or a named account mark. The old outer-road phrase answers surface strangers directly, immediately after Westroot has suffered a covert breach.

The arrival scene should state this distinction. Bramwell's concern is then specific: someone opened his gate from outside without using the authorization system he is responsible for, and he does not yet know whether a watcher followed.

### What opens at each resolution
...
- outgoing warnings are copied to Bramblecross;
- shelter and water signals are restored;
- Westroot establishes a formal contact with Enna or another accountable Bramblecross representative;
- unmarked cargo and anonymous authority are refused.

This is controlled, witnessed reconnection rather than unrestricted public access. The ending should show the first named warning or messenger leaving for Bramblecross so the decision is experienced as an event rather than inferred from one sentence.
