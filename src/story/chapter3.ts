...
export const CHAPTER_3_SCENE_COPY = {
  ...
  mossgarden: {
    ...
    text:
      "Water runs through shallow stone channels beneath pale moss. Old name tablets and lantern hooks sit among the roots. A Mossback caretaker brushes dirt from a stone without hurrying.\n\n\"Do not step on the names,\" they say. \"Most of them have already been walked over enough. I am Noma Greenstill.\"\n\nNoma begins with the physical history. About sixty years ago, Witherdeath entered through ordinary admitted traffic, before Westroot had orderly washing, airing, or observation. The sanitation now built into the Transfer Checkpoint was a prudent answer. Ending routine surface compacts, vanishing from public maps, and keeping Bramblecross at a distance for generations was the fearful answer that became permanent.",
    repeat:
  ...
  splitHall: {
    ...
    resolution:
      "You lay the false cargo evidence beside the Witness Stone Rubbing.\n\nBramwell says, \"I asked for the gate closed because the danger was real.\"\n\n\"And our silence became useful to the people who lied,\" Noma answers.\n\nSplit Hall establishes Westroot's first restored surface compact with Bramblecross. The First Gate remains guarded. People and cargo require names, confirmation, and witnesses. Warnings and shelter signals travel outward again, first to Enna, Hollis, and their named watch or courier contacts.\n\nQuill takes the first written warning and leaves for Bramblecross while the Rootmarket baker sets bread on the table. The decision has become an action.",
  },
  closing: {
...
export const CHAPTER_3_FULL_SCENE_COPY = {
  ...
  rootmarket: {
    ...
    quillNameReaction: "Quill repeats the names without hesitation, then points back at the hinge. \"Good. Named hands are easier to ask for help. Three nights ago, a scheduled Willow-marked shipment and an unnamed westbound courier arrived with correct-looking credentials. Your party opened an old phrase-lock with no account and nobody inside expecting you. Those are two different arrivals, and both are now our problem.\"",
  ...
  auntieLume: {
    ...
    promiseResponse: "\"If a traveler waits hungry, you feed them before trust is settled. A guarded boundary may delay passage; it may not make a hungry person invisible. Go back to the Transfer Checkpoint. Ask my helper what happened, and do not finish the child's story for them.\"",
  ...
  rootbread: {
    ...
    introduction: "Back at the Transfer Checkpoint, Lume's young helper waits beside the ordinary rootbread tray. The child points to the wash basin, airing rack, inspection bench, and account rail in the order every admitted traveler uses them.\n\n\"The hooded courier waited here with the Willow crate and two handlers,\" they say. \"I brought the same bread and water everybody gets. I kept the cup he returned because it had a knot I did not know.\"",
    appearanceResponse: "\"He was young,\" the child says. \"Hood over his face. His hands were tied, and the handlers stood too close even while the crate waited at the same account rail. He ate the bread. He watched everything.\"",
    routineResponse: "\"Everybody waiting here gets the tray before the gate decides,\" the child says. \"If the handlers refused it, Bramwell would have asked why they were breaking the ordinary routine. So they let him eat. He tied something around the cup before he gave it back.\"",
...
export function buildChapterThreeRecap(flags: Partial<Flags> = {}) {
  ...
  const rootbreadOutcome = flags.rootbreadPromiseKept
    ? "Lio's returned cup proved the Rootbread Promise reached him, and the checkpoint tray was restocked"
