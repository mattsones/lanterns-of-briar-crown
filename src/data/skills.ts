export const SKILL_DB = {
  ...
  rootbread_respite: { id: "rootbread_respite", name: "Rootbread Respite", kind: "guardHeal", stats: ["Heart", "Will"], divisor: 3, baseHeal: 5, baseGuard: 3, cooldown: 4, description: "Remember the promise made at Westroot's checkpoint: restore HP and brace yourself to shelter the next traveler. Cooldown: 4 turns." },
