...
export const MAPS = {
  ...
  underwayRoute811: {
    ...
    tiles: [
      ...
      ["mapped_gallery", "underway_path", "wall", "wall", "underway_path", "wall", "wall", "underway_path", "wall", "underway_route_exit"],
      ["wall", "wall", "wall", "wall", "wall", "waykeeper_cache", "underway_path", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  underwayRoute817: {
    ...
    tiles: [
      ...
      ["maintenance_hatch", "wall", "wall", "underway_path", "wall", "wall", "underway_path", "wall", "underway_path", "underway_route_exit"],
      ["wall", "underway_path", "underway_path", "wall", "wall", "wall", "wall", "underway_path", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  underwayConvergence: {
    ...
    tiles: [
      ...
      ["convergence_entry", "wall", "wall", "underway_path", "wall", "ambush_approach", "underway_ambush", "wall", "wall", "convergence_exit"],
      ["wall", "wall", "wall", "wall", "underway_path", "wall", "wall", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  listeningPostOne: {
    ...
    tiles: [
      ...
      ["listening_mile_entry", "underway_path", "wall", "wall", "underway_path", "underway_path", "wall", "underway_path", "wall", "listening_mile_exit"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  listeningPostTwo: {
    ...
    tiles: [
      ...
      ["listening_mile_entry", "wall", "wall", "underway_path", "underway_path", "wall", "wall", "underway_path", "wall", "listening_mile_exit"],
      ["wall", "wall", "wall", "wall", "wall", "underway_path", "listening_post_two", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  listeningPostThree: {
    ...
    tiles: [
      ...
      ["listening_mile_entry", "underway_path", "wall", "wall", "underway_path", "underway_path", "wall", "underway_path", "lio_message_plate"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  relayApproach: {
    ...
    tiles: [
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
      ["wall", "underway_path", "underway_path", "wall", "wall", "wall", "wall", "underway_path", "underway_path", "wall"],
      ["relay_approach_entry", "wall", "wall", "underway_path", "underway_path", "wall", "underway_path", "wall", "wall", "relay_post_gate"],
      ["wall", "wall", "wall", "wall", "wall", "underway_path", "wall", "wall", "wall", "wall"],
      ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
    ],
  },
  briarRelayPost: {
...
Object.assign(TILE_META, {
  ...
  maintenance_hatch: makeTile("↯", "Posted construction detour", false, "bg-orange-950/85"),
  waykeeper_cache: makeTile("chest", "Abandoned Waykeeper Cache", false, "bg-amber-950/90"),
  construction_signal_rig: makeTile("pulley", "Construction Signal Rig", false, "bg-orange-950/90"),
  ...
  underway_route_exit: makeTile("→", "Route Convergence", false, "bg-slate-800/90"),
  convergence_entry: makeTile("◇", "Converged Tunnel", false, "bg-slate-800/90"),
  convergence_exit: makeTile("→", "Listening Mile Threshold", false, "bg-sky-950/90"),
  listening_mile_entry: makeTile("·", "Listening-Mile Passage", false, "bg-slate-800/90"),
  listening_mile_exit: makeTile("→", "Deeper Listening Tunnel", false, "bg-sky-950/90"),
  listening_post_one: makeTile("◫", "Wall Listening Hood", false, "bg-sky-900/85"),
  ...
  lio_message_plate: makeTile("▤", "Loose Route-Record Plate", false, "bg-indigo-950/90"),
  relay_approach_entry: makeTile("·", "Westbound Relay Tunnel", false, "bg-slate-800/90"),
  relay_post_gate: makeTile("→", "Briar Relay Post", false, "bg-rose-950/90"),
  relay_entry: makeTile("◁", "Relay Post Approach", false, "bg-slate-800/90"),
  royal_progress_broadside: makeTile("♔", "Royal Progress Broadside", false, "bg-indigo-900/90"),
  relay_guard: makeTile("!", "Guarded Relay Floor", false, "bg-red-950/90"),
  forged_order_desk: makeTile("seal", "Forged-Authority Desk", false, "bg-rose-950/90"),
  briarhold_route_ledger: makeTile("book", "Westbound Route Ledger", false, "bg-amber-950/90"),
});
