...
| Witness Stones public renewal | `witness-stones-public-renewal-scene-v02.webp` | Current runtime scene with exactly four road-promise stones and no false Crown plaque. Chapter 3 release-candidate closeout must replace it with a public-renewal composition showing Bramwell and Noma opening the hold, Quill recording the new order, and neighbors taking responsibility at the four stones. Preserve the established symbols and fallback-safe wiring; keep v02 as an alternate after replacement. |
