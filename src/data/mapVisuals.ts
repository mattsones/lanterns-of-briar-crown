...
export const MAP_VISUALS: Record<string, MapVisualConfig> = {
  ...
  westrootHub: {
    ...
    fogRevealAreas: [
      {
        id: "westroot-gate-approach",
        nodeKeys: ["1,3", "1,4", "2,4", "2,5", "2,3", "3,4"],
        x: 27,
        y: 79,
        radiusX: 17,
        radiusY: 13,
      ...
      {
        id: "westroot-central-plaza",
        nodeKeys: ["5,3", "6,3", "6,4", "7,3"],
        x: 61,
        y: 51,
        radiusX: 18,
        radiusY: 13,
