...
export const CHAPTER_FLAG_DEFAULTS: Flags = {
  ...
  companionReadLanternDoor: false,
  ...
  metBramwell: false,
  metNoma: false,
  nomaAskedNames: false,
  nomaAskedCourier: false,
  nomaAskedGate: false,
  nomaIntroducedWitnessStones: false,
  rootmarketVisited: false,
  rootmarketVoicesHeard: false,
  metQuill: false,
  quillAskedOldRoad: false,
  quillAskedCargo: false,
  metAuntieLume: false,
  lumeMentionedRootbread: false,
  lumeAskedLio: false,
  lumeAskedHospitality: false,
  lumeAskedPromise: false,
  rootbreadLeadLearned: false,
  metRootbreadChild: false,
  rootbreadChildAskedWhen: false,
  rootbreadChildAskedSafety: false,
  rootbreadPromiseKept: false,
  lioKnotFound: false,
  westrootHoldBellRung: false,
  splitHallVisitedBeforeBell: false,
  splitHallDebateHeard: false,
  splitHallAskedOuterShelter: false,
  splitHallAskedGateCost: false,
  splitHallAskedCargoHold: false,
  witnessStoneFirstAttemptMissed: false,
  witnessPromiseWitnessChosen: false,
  witnessPromiseWarningChosen: false,
  witnessPromiseShelterChosen: false,
  witnessPromiseWaterChosen: false,
  ...
  gatewrightMet: false,
  gatewrightWeaponPurchased: false,
  foldedMapAttempted: false,
  foldedMapFirstAttemptMistake: false,
  foldedMapDecoded: false,
  foldedMapDeeperSolved: false,
    foldedMapMaintenanceDetour: false,
    foldedMapCacheClaimed: false,
    underwayEntered: false,
    surveyStationReached: false,
    rootwaterApproachSeen: false,
    rootwaterBridgeSeen: false,
    rootwaterBridgeCrossed: false,
    underwayWildlifeCleared: false,
    underwayDetourNoticeInspected: false,
  underwayDetourDecisionMade: false,
  underwayDetourFollowed: false,
  underway811CacheFound: false,
  underway817SignalRigRead: false,
  underwayAmbushDetectionAttempted: false,
  underwayAmbushRevealed: false,
  underwayAmbushPrepared: false,
  underwayAmbushCleared: false,
  listeningMileAttempted: false,
  listeningMileOutcome: null,
  captivePorterHelped: false,
  lioMessageFound: false,
  royalProgressLearned: false,
  princessNameSeen: false,
  briarRelayCleared: false,
