export const ITEM_DB = {
  ...
  witness_stone_rubbing: { id: "witness_stone_rubbing", name: "Witness Stone Rubbing", rarity: "Story", type: "story", description: "A rubbing from Westroot's witness stones, preserving old road marks that name truth before command.", icon: "🪨" },
