...
const WESTROOT_HUB_NAV_CONNECTIONS: NavConnection[] = [
  ...
  { from: "3,3", to: "2,2", direction: "left" },
  { from: "2,2", to: "3,2", direction: "left" },
  { from: "3,2", to: "3,1", direction: "up" },
  { from: "3,1", to: "2,1", direction: "up" },
  { from: "2,1", to: "3,0", direction: "up" },
  { from: "3,0", to: "4,0", direction: "right" },
  { from: "4,0", to: "5,0", direction: "up" },
  { from: "5,0", to: "4,1", direction: "right" },
  { from: "5,3", to: "4,2", direction: "up" },
  { from: "4,2", to: "5,2", direction: "up" },
  { from: "7,3", to: "7,4", direction: "down" },
  { from: "7,4", to: "6,5", direction: "down" },
  { from: "6,5", to: "7,5", direction: "right" },
];
...
const WESTROOT_HUB_NAVIGATION_ALIASES: NavConnection[] = [
  ...
  { from: "4,3", to: "4,4", direction: "up" },
  { from: "4,4", to: "5,3", direction: "up" },
  { from: "6,3", to: "6,4", direction: "up" },
  { from: "7,2", to: "6,2", direction: "right" },
  { from: "6,2", to: "7,1", direction: "right" },
  { from: "2,2", to: "3,2", direction: "up" },
  { from: "3,2", to: "3,1", direction: "left" },
  { from: "3,0", to: "4,0", direction: "up" },
  { from: "4,0", to: "5,0", direction: "right" },
  { from: "7,4", to: "6,5", direction: "right" },
  { from: "6,5", to: "7,5", direction: "down" },
];
